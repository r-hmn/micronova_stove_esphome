...
// Original from: https://github.com/eni23/micronova-controller

/* =================================
 * Changelog
 * =================================
 * 2026-05-01  Changed timing to fit speedup for ARTEL IDRO.
 *             (Used "USB logic analyzer" to see dead-times in communication)
 * 2026-05-03  Added ARTEL addresses
 * =================================*/
...
// addresses
#define STOVE_ADDR_AMBIENT_TEMP   0x01 /*   1 */
#define STOVE_ADDR_STATE          0x21 /*  33 */
#define STOVE_ADDR_FUMES_TEMP     0x3E /*  62 */
#define STOVE_ADDR_FUMES_SPEED    0x37 /*  55 */
#define STOVE_ADDR_POWER_RAM      0x34 /*  52 */
#define STOVE_ADDR_POWER_EEPROM   0x7F /* 127 */
#define STOVE_ADDR_IRCOMMAND      0x58 /*  88 */
#define STOVE_ADDR_THERMOSTAT     0x7D /* 125 */
// Extra: Stove "ARTEL - IDRO 15 GPAR" addressess
#define STOVE_ADDR_ARTEL_FUMES_TEMP     88 /* 0x58 */
#define STOVE_ADDR_ARTEL_WATER_TEMP     3
#define STOVE_ADDR_ARTEL_WATER_PRESS    60 /* 0x3C */
